...
const About1 = ({ amount, goldInGrams, goldPrice, formattedTime }) => {
  ...
  const handleGetStarted = () => {
   ...
   const handleGetStartedee = () => {
    navigate('/help'); // navigate to register route
  };
  return (
    <>
      <div>
        ...
        <div className="main-container">
          ...
          <div className="cards">
            ...
            <div className="card1">
              ...
              <h2 className='h2'>Automated system</h2>
              <p className="desc">
            ...
            <div className="card2">
              ...
              <div className="card-inner">
                ...
                <div className="slider-section">
                  <div className="slider-thumb">Rs. 20 will be saved daily</div>
                </div>
              </div>
              <h2 className='h22'>More ways to Trading</h2>
            ...
            <div className="card3">
              ...
              <h2 className='trade'>Trading anytime</h2>
              <p className="desc">
        ...
        <div className="faq-header">
          ...
          <div className="faq-tabs">
            <button className="faq-tab" style={{ backgroundColor: 'darkgoldenrod' }}>All FAQs</button>  
          ...
          <div className="accordion">
            <div className="faq-item expanded">
              <div className="faq-question">
                <strong style={{ color: '#ffffff' }}>Is MetaGold App safe to use?</strong>
                <span className="arrow">&#9660;</span>
              </div>
              <div className="faq-answer" style={{ color: '#ffffff' }}>
                MetaGold app is 100% safe and secure to use for your Daily Savings & Trading in Gold.
            ...
            <div className="faq-item" >
              <div className="faq-question" style={{ color: '#ffffff' }}>
                <strong>What does the MetaGold App do?</strong>
                <span className="arrow">&#9660;</span>
              </div>
            </div>
            ...
            <div className="faq-item">
              <div className="faq-question" style={{ color: '#ffffff' }}>
                <strong>How do I download the MetaGold App?</strong>
                <span className="arrow">&#9660;</span>
              </div>
            </div>
